var user_params = { user: ['first_name', 'last_name', 'email', 'number', 'username_postfix', 'premium'], device: [ 'device_id', 'device_type', 'notification_id', 'can_notify' ] };
var api = [
  { 
  ...
  { 
    path: "GET /api/v1/posts.json",
    params: { scope: ['latitude', 'longitude'] }
  },
  { 
    path: "POST /api/v1/me/posts.json",
    params: { post: ['body', 'latitude', 'longitude'] }
  },
  { 
    path: "PUT /api/v1/me/posts/:id.json",
    params: { post: ['body', 'latitude', 'longitude'] }
  },
  { 
    path: "POST /api/v1/me/comments.json",
    params: { comment: ['body', 'post_id'] }
  },
  { 
  ...
  { 
    path: "DELETE /api/v1/me/posts/:id.json"
  },
  { 
